...
Thank you for choosing Maison Vie.`},q={vi:t=>`Chào ${t.customerName||"Quý Khách"},
...
- Thực đơn: ${g(t,"vi")}`,m=o!=null&&o.internalStatusChangeBody?z(o.internalStatusChangeBody,t,e,n,"vi"):l,u=v(`📋 CẬP NHẬT: ${a} → ${r}`,s.amber,`
        ...
        `,"vi");return{subject:c,html:u,text:m}},buildCustomerCancellation(t,e){const n=I(t),o=S[n].cancelled,i=P[n],a=e!=null&&e.customerCancelBody?C(e.customerCancelBody,t,n):q[n](t),r=v(S[n].cancelledTitle,s.red,`
