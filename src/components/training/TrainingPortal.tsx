...
const initialCourses: Course[] = [
  // Level 1: Nhập môn (Onboarding)
  { id: '1-1', title: 'Văn hóa & Tầm nhìn Maison Vie', thumbnail: 'https://img.youtube.com/vi/M7lc1UVf-VE/maxresdefault.jpg', duration: '12:00', progress: 100, level: 1, youtubeId: 'M7lc1UVf-VE' },
  { id: '1-2', title: 'Quy trình phục vụ cơ bản', thumbnail: 'https://img.youtube.com/vi/tgbNymZ7vqY/maxresdefault.jpg', duration: '18:00', progress: 100, level: 1, youtubeId: 'tgbNymZ7vqY' },
  { id: '1-3', title: 'An toàn vệ sinh thực phẩm (HACCP)', thumbnail: 'https://img.youtube.com/vi/aqz-KE-bpKQ/maxresdefault.jpg', duration: '15:00', progress: 100, level: 1, youtubeId: 'aqz-KE-bpKQ' },
  { id: '1-4', title: 'Sử dụng hệ thống POS & KDS', thumbnail: 'https://img.youtube.com/vi/LXb3EKWsInQ/maxresdefault.jpg', duration: '20:00', progress: 80, level: 1, youtubeId: 'LXb3EKWsInQ' },
  { id: '1-5', title: 'Nội quy & Đồng phục nhà hàng', thumbnail: 'https://img.youtube.com/vi/ZbZSe6N_BXs/maxresdefault.jpg', duration: '10:00', progress: 0, level: 1, youtubeId: 'ZbZSe6N_BXs' },

  // Level 2: Cơ bản (Core Skills)
  { id: '2-1', title: 'Kỹ năng giao tiếp khách hàng', thumbnail: 'https://img.youtube.com/vi/8aGhZQkoFbQ/maxresdefault.jpg', duration: '22:00', progress: 0, level: 2, youtubeId: '8aGhZQkoFbQ' },
  ...
  { id: '2-3', title: 'Nghệ thuật set bàn & trang trí', thumbnail: 'https://img.youtube.com/vi/Sagg08DrO5U/maxresdefault.jpg', duration: '18:00', progress: 0, level: 2, youtubeId: 'Sagg08DrO5U' },
  { id: '2-4', title: 'Phục vụ tiệc & sự kiện đặc biệt', thumbnail: 'https://img.youtube.com/vi/YQHsXMglC9A/maxresdefault.jpg', duration: '28:00', progress: 0, level: 2, youtubeId: 'YQHsXMglC9A' },
  { id: '2-5', title: 'Teamwork & phối hợp bếp-phục vụ', thumbnail: 'https://img.youtube.com/vi/hT_nvWreIhg/maxresdefault.jpg', duration: '16:00', progress: 0, level: 2, youtubeId: 'hT_nvWreIhg' },

  // Level 3: Nâng cao (Advanced)
  { id: '3-1', title: 'Kiến thức rượu vang & pairing', thumbnail: 'https://img.youtube.com/vi/N2ZqE1Jk2r0/maxresdefault.jpg', duration: '35:00', progress: 0, level: 3, youtubeId: 'N2ZqE1Jk2r0' },
  { id: '3-2', title: 'Upselling & Cross-selling nghệ thuật', thumbnail: 'https://img.youtube.com/vi/Q8TXgCzxEnw/maxresdefault.jpg', duration: '22:00', progress: 0, level: 3, youtubeId: 'Q8TXgCzxEnw' },
  { id: '3-3', title: 'Kiến thức cocktail & đồ uống cao cấp', thumbnail: 'https://img.youtube.com/vi/fJ9rUzIMcZQ/maxresdefault.jpg', duration: '30:00', progress: 0, level: 3, youtubeId: 'fJ9rUzIMcZQ' },
  { id: '3-4', title: 'Xử lý dị ứng & chế độ ăn đặc biệt', thumbnail: 'https://img.youtube.com/vi/2Vv-BfVoq4g/maxresdefault.jpg', duration: '20:00', progress: 0, level: 3, youtubeId: '2Vv-BfVoq4g' },
  { id: '3-5', title: 'Phong cách phục vụ Fine Dining', thumbnail: 'https://img.youtube.com/vi/CevxZvSJLk8/maxresdefault.jpg', duration: '25:00', progress: 0, level: 3, youtubeId: 'CevxZvSJLk8' },

  // Level 4: Chuyên sâu (Specialist)
  { id: '4-1', title: 'Quản lý chất lượng dịch vụ (SOP)', thumbnail: 'https://img.youtube.com/vi/dQw4w9WgXcQ/maxresdefault.jpg', duration: '35:00', progress: 0, level: 4, youtubeId: 'dQw4w9WgXcQ' },
  { id: '4-2', title: 'Xây dựng menu & Food cost', thumbnail: 'https://img.youtube.com/vi/jNQXAC9IVRw/maxresdefault.jpg', duration: '28:00', progress: 0, level: 4, youtubeId: 'jNQXAC9IVRw' },
  { id: '4-3', title: 'Training & Mentoring nhân viên mới', thumbnail: 'https://img.youtube.com/vi/kXYiU_JCYtU/maxresdefault.jpg', duration: '30:00', progress: 0, level: 4, youtubeId: 'kXYiU_JCYtU' },
  { id: '4-4', title: 'Quản lý kho & Inventory Control', thumbnail: 'https://img.youtube.com/vi/RgKAFK5djSk/maxresdefault.jpg', duration: '25:00', progress: 0, level: 4, youtubeId: 'RgKAFK5djSk' },
  { id: '4-5', title: 'Đánh giá hiệu suất & KPI nhà hàng', thumbnail: 'https://img.youtube.com/vi/JGwWNGJdvx8/maxresdefault.jpg', duration: '32:00', progress: 0, level: 4, youtubeId: 'JGwWNGJdvx8' },

  // Level 5: Quản lý (Management)
  { id: '5-1', title: 'Quản lý nhân sự & ca làm việc', thumbnail: 'https://img.youtube.com/vi/9bZkp7q19f0/maxresdefault.jpg', duration: '40:00', progress: 0, level: 5, youtubeId: '9bZkp7q19f0' },
  { id: '5-2', title: 'Chiến lược kinh doanh F&B', thumbnail: 'https://img.youtube.com/vi/kJQP7kiw5Fk/maxresdefault.jpg', duration: '45:00', progress: 0, level: 5, youtubeId: 'kJQP7kiw5Fk' },
  { id: '5-3', title: 'Marketing & Branding nhà hàng', thumbnail: 'https://img.youtube.com/vi/OPf0YbXqDm0/maxresdefault.jpg', duration: '35:00', progress: 0, level: 5, youtubeId: 'OPf0YbXqDm0' },
  { id: '5-4', title: 'Quản lý tài chính & P&L báo cáo', thumbnail: 'https://img.youtube.com/vi/60ItHLz5WEA/maxresdefault.jpg', duration: '38:00', progress: 0, level: 5, youtubeId: '60ItHLz5WEA' },
  { id: '5-5', title: 'Xử lý khủng hoảng & Quản trị rủi ro', thumbnail: 'https://img.youtube.com/vi/pRpeEdMmmQ0/maxresdefault.jpg', duration: '30:00', progress: 0, level: 5, youtubeId: 'pRpeEdMmmQ0' },
];
